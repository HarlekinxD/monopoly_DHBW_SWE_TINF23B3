...
def create_standard_board() -> Board: 
    tiles = [
        SpecialTile(tile_id=0,
                    name="LOS",
                    tile_type = TileType.SPECIAL,
                    ),
        
        PropertyTile(tile_id=1, 
             name="Badstraße",
        ...
        SpecialTile(tile_id=2,
                    name="Gemeinschaftsfeld",
                    tile_type = TileType.SPECIAL,
        ),
        
        PropertyTile(tile_id=3, 
             name="Turmstraße",
             tile_type=TileType.PROPERTY,
             price=Money(60),
             color = TileColor.PURPLE,
        ...
        SpecialTile(tile_id=7, 
            name="Ereignisfeld", 
            tile_type=TileType.SPECIAL,
        ),
        
        PropertyTile(tile_id=8, 
             name="Elisenstraße",
             tile_type=TileType.PROPERTY,
             price=Money(100),
             color = TileColor.CYAN,
        ...
        SpecialTile(tile_id=10,
                    name="Im Gefängnis (Nur zu Besuch)", 
                    tile_type=TileType.SPECIAL,
        ),

        PropertyTile(tile_id=11,
             name="Seestraße",
             tile_type=TileType.PROPERTY,
             price=Money(140),
        ...
        SpecialTile(tile_id=17,
                    name="Gemeinschaftsfeld",
                    tile_type=TileType.SPECIAL,
        ),
        
        PropertyTile(tile_id=18,
                    name="Wiener Straße",
                    tile_type=TileType.PROPERTY,
                    price=Money(180),
                    color=TileColor.ORANGE,
        ...
        SpecialTile(tile_id=20,
                     name="Frei Parken",
                     tile_type=TileType.SPECIAL,
        ),
        
        PropertyTile (tile_id=21,
                      name= "Theaterstraße",
                      tile_type=TileType.PROPERTY,
                      price=Money(220),
                      color=TileColor.RED,
        ...
        SpecialTile(tile_id=22,
                    name="Ereignisfeld",
                    tile_type=TileType.SPECIAL,
        ),                  
        
        PropertyTile(tile_id=23, 
             name="Museumstraße",
             tile_type=TileType.PROPERTY,
             price=Money(220),
             color = TileColor.RED,
        ...
        SpecialTile(tile_id=30,
                    name="Gehe ins Gefängnis",
                    tile_type=TileType.SPECIAL,
        ),
        
        PropertyTile(tile_id=31, 
             name="Rathausplatz",
             tile_type=TileType.PROPERTY,
             price=Money(300),
        ...
        SpecialTile(tile_id=33,
                    name="Gemeinschaftsfeld",
                    tile_type=TileType.SPECIAL,
        ),
        
        PropertyTile(tile_id=34, 
             name="Bahnhofstraße",
             tile_type=TileType.PROPERTY,
             price=Money(320),
             color = TileColor.GREEN,
        ...
        SpecialTile(tile_id=36,
                    name="Ereignisfeld",
                    tile_type=TileType.SPECIAL,
        ),
        
        PropertyTile(tile_id=37, 
             name="Parkstraße", 
             tile_type=TileType.PROPERTY,
             price=Money(350),
