...
class BoardRenderer:
    ...
    def _render_horizontal_row(self, tiles, game: Game) -> list[str]:
    ...
    def _cell_content(self, tile, game: Game) -> list[str]:
    ...
    def _render_tile_line(self, tile, game: Game) -> str:
        players = [
